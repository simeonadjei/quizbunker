      ...
      <div className="flex-1 flex flex-col items-center px-4 sm:px-6 text-center relative z-10 w-full">
        ...
        <div className="w-full max-w-sm sm:max-w-2xl lg:max-w-5xl xl:max-w-6xl mx-auto">
          ...
          <div className="w-full mt-10 sm:mt-14 mb-4">
            ...
            {/* Live badge */}
            <div
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border font-bold text-sm uppercase tracking-widest mb-6"
              style={{
            ...
            <div className="relative inline-block w-full">
              ...
              <h1 className="text-game-title text-6xl sm:text-7xl lg:text-8xl leading-tight relative z-10">QUIZ</h1>
              <h1 className="text-game-title-orange text-7xl sm:text-8xl lg:text-9xl leading-none relative z-10"
            ...
            {/* Tagline */}
            <p className="font-bold text-lg sm:text-xl leading-relaxed mt-6"
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full mt-8 sm:max-w-lg sm:mx-auto lg:max-w-md">
            {isLoading ? null : user ? (
              ...
              <>
                <Link href="/register" className="btn-game flex-1 py-5 text-xl justify-center">
                  Create Free Account
                </Link>
                <Link href="/login" className="btn-game-secondary flex-1 py-4 text-lg justify-center">
                  I Have an Account
                </Link>
              </>
            )}
...
function WhatsAppShare() {
  ...
  return (
    <div className="rounded-2xl p-6 flex flex-col items-center gap-4 text-center justify-center"
      style={{
...
function FeatureCard({ icon, title, desc, borderColor, iconBg }: {
  ...
  return (
    <div
      className="card-game p-5 flex flex-col sm:flex-col items-start gap-4 text-left border-l-4 h-full"
