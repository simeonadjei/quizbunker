  ...
  return (
    ...
    <div className="h-[100dvh] flex flex-col bg-background text-foreground overflow-hidden relative">
      ...
      <header className="relative z-40 shrink-0 bg-background/90 backdrop-blur-md border-b-2 border-primary/40">
        <div className="max-w-lg mx-auto px-3 h-12 sm:h-14 flex items-center gap-2.5 sm:gap-3">
          <div
            className="bg-primary text-white w-9 h-9 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center font-display text-sm sm:text-base shrink-0 border-2 border-white/40"
            style={{ boxShadow: '0 3px 0 hsl(22 90% 30%)' }}
          >
            W{session.week}
          </div>
          <div className="flex-1 min-w-0 hidden xs:block">
            <span className="font-display text-white text-xs sm:text-sm leading-none block truncate">{session.subject}</span>
            <span className="text-white/50 text-[10px] sm:text-xs font-bold">{session.year}</span>
          </div>
          ...
          <div className="hud-badge !px-2 sm:!px-3 !py-1 text-[11px] sm:text-xs shrink-0">
          ...
          <div className="relative shrink-0">
            <button
              onClick={() => { setShowGridHint(false); setLocation('/dashboard'); }}
               className="w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center rounded-xl border-2 border-white/15 bg-black/30 text-white/50 hover:border-white/40 hover:text-white transition-all active:scale-90"
              title="Switch week"
            >
      ...
      {currentQuestion && (
        ...
        >
          ...
          {(currentQuestion as any).weekTopic && (
            ...
            >
              <div
                className="inline-flex max-w-full items-center gap-1 px-2 sm:px-2.5 py-0.5 rounded-full text-[9px] sm:text-[10px] font-bold uppercase tracking-wider border"
                style={{
        ...
        <div className="max-w-lg mx-auto px-3 sm:px-4 py-2.5 sm:py-3 flex flex-col gap-2 sm:gap-2.5 pb-5">
          ...
          {currentQuestion && (['A', 'B', 'C', 'D'] as const).map((key) => {
            ...
            return (
              <button
                ...
                className={cn(
                   'relative flex flex-row items-center gap-2.5 sm:gap-3 rounded-xl sm:rounded-2xl border-2 transition-all duration-200 py-2.5 sm:py-3 px-3 sm:px-4 text-left w-full',
              ...
              >
                {/* Letter badge */}
                <div className={cn(
                   'w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl flex items-center justify-center font-display text-base sm:text-lg border-2 shrink-0',
          ...
          {isCurrentRevealed && currentQuestion && (() => {
            ...
            return (
              <div ref={feedbackRef} className={cn(
                 'rounded-2xl p-3.5 sm:p-4 border-l-4 animate-in slide-in-from-bottom-3 duration-300',
      ...
      <div
        className="relative z-40 shrink-0 border-t-2 border-white/10 px-3 sm:px-4 py-2.5 sm:py-3 flex justify-between items-center gap-2 sm:gap-3"
        style={{
      ...
      >
        <button
          ...
          className={cn(
            'btn-game px-4 sm:px-5 py-2 sm:py-2.5 text-sm sm:text-base flex items-center gap-1.5',
        ...
        {isComplete && isLastQuestion && isCurrentRevealed ? (
          <button
            ...
            className={cn(
              'btn-game-accent flex-1 py-2 sm:py-2.5 text-sm sm:text-base flex items-center justify-center gap-2',
